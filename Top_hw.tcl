...
add_fileset_file Top.v VERILOG PATH ip_src/Top.v TOP_LEVEL_FILE
add_fileset_file SRAMVerilogAWS VERILOG PATH ip_src/SRAMVerilogAWS.v
add_fileset_file RetimeShiftRegister.sv SYSTEM_VERILOG PATH ip_src/RetimeShiftRegister.sv
